class ProductDetails {
  ...
  ProductDetails.fromJson(Map<String, dynamic> json) {
    ...
    productCardModel = json['product'] != null ? ProductCardModel.fromJson(json['product']) : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (productCardModel != null) {
      data['product'] = productCardModel!.toJson();
    }
    return data;
  }
}
...
class Category {
  ...
  Category({this.id, this.categoryName, this.categoryImg, this.createdAt, this.updatedAt});
