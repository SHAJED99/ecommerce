...
class HomeNewProduct extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        HomeSectionTitle(categoriesName: "New", onTap: () {}),
        Obx(() => AnimatedSize(
              duration: const Duration(milliseconds: defaultDuration),
              child: dataController.isError.value && dataController.newProductList.isEmpty
                  ? SizedBox(
                  ...
                  : Padding(
                      ...
                      child: Row(
                        children: [
                          for (int i = 0; i < 3 && i < dataController.newProductList.length; i++)
                            Expanded(
                              child: Center(
                                child: ProductCard(
                                  productModel: dataController.newProductList.elementAt(i),
                                  // onTap: () {
