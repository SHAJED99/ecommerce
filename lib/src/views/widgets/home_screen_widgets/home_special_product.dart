...
class HomeSpecialProduct extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        HomeSectionTitle(categoriesName: "Special", onTap: () {}),
        Obx(() => AnimatedSize(
              duration: const Duration(milliseconds: defaultDuration),
              child: dataController.isError.value && dataController.specialProductList.isEmpty
                  ? SizedBox(
                  ...
                  : Padding(
                      ...
                      child: Row(
                        children: [
                          for (int i = 0; i < 3 && i < dataController.specialProductList.length; i++)
                            Expanded(
                              child: Center(
                                child: ProductCard(
                                  productModel: dataController.specialProductList.elementAt(i),
                                  // onTap: () {
